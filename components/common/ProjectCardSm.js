...
const ProjectCardSm = ({ item }) => {
  return (
    <div className="tn-shadow-1 bg-white hover:bg-gray-400/10 dark:bg-white/5 dark:hover:bg-white/10 transition-all bg-opacity-50 backdrop-filter backdrop-blur-lg p-4">
